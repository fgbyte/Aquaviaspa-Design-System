export const transform1 = `
<section class="d-lg-flex gap-1 position-relative">
    <article id="card-transform" class="card-transform" style="background-image: url('/dist/assets/img/card-transform.webp');">
    ...
    <article class="card-transform-right" style="background-image: url('/dist/assets/img/card-transform-rigth2.webp');">
      <div class="card-transform__card-inside">
        <img class="card-transform__card-inside--img" src="/dist/assets/icons/Logo.svg" alt="Logo">
        <h3>Swimspas</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt labore.</p>
