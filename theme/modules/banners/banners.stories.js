    ...
    <section class="banner-cta-center">
        <div class="banner-cta-center__card">
            <div class="banner-cta-center__card__logo">
                ...
                <svg width="98px" height="3px" viewBox="0 0 98 3" version="1.1"
...
//hero banner medium
export const bannerHeroMedium1 = `
...
//hero banner video
export const bannerHeroMediumVideo = `
    <section class="banner banner--video">
        ...
        <script type="text/javascript">
            document.querySelector('.glightbox.play-btn').addEventListener('click', function () {
                ...
                link.rel = 'stylesheet';
                link.href = '/dist/vendors/glightbox.min.css';
...
<section id="hero" class="banner-blog">
        <h1>Blog</h1>
    </section>
`

//banner Contacto
export const bannerContacto1 = `
<style>
      .banner-contacto {
