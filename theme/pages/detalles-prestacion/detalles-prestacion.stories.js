...
<head>
    ...
    <title>Detalles Prestacion</title>
</head>
...
<body class="posts-page">
    ...
    <section id="hero" class="banner-posts">
        <div class="banner-posts__img">
            <img class="image-sm" src="/dist/assets/img/card-barcelona-design.webp" alt="">
            <img class="image-lg" src="/dist/assets/img/card-barcelona-design.webp" alt="">
            <div class="banner-posts__logo">
                <img src="/dist/assets/icons/logo-bcn-desing-white.webp" alt="">
            </div>
        </div>
    </section>
    <!-- *****Intro Vertical******* -->
    <section class="intro-vertical">
        <div class="intro-vertical__text">
            <h2>BCN Design</h2>
            <h4>Acabados de extraordinario valor añadido que nos posicionan en la vanguardia del diseño de spas</h4>
            <div>
                <p>Barcelona es una de las ciudades mundiales del diseño. Su carácter cosmopolita y su tradición
                    creativa la convierten en una de las cunas de grandes tendencias a nivel internacional y en uno de
                    los polos de innovación en Europa. </p>
                <p>Aquavia Spa se impregna de esta esencia para marcar un estilo propio, con ingenieros creativos y
                    diseñadores innovadores. Gracias a esta vocación creativa, en consonancia con la visión estratégica
                    de nuestra dirección, buscamos que nuestros spas sean únicos, con carácter propio y diseño
                    exclusivo.</p>
            </div>
        </div>
    </section>
    <!-- *****Prestaciones Slider******* -->
    <section class="prestaciones-slider prestaciones-slider--detalles mx-auto posts-page__slider section-slider-accsesorios">
        <div class="section-slider-accsesorios__header">
            <h3>OTRAS PRESTACIONES QUE LE PUEDEN INTERESAR</h3>
        </div>
        <div class="guias-prestaciones-slider__slider-arrow guias-otras-prestaciones-arrow">
            ...
            <div class="prestaciones-slider__slider">
              ...
              <div class="card-prestacion-lite logo-down">
                ...
                <div class="card-prestacion-lite__sub">
                  ...
                  <div class="card-prestacion-lite__text">
                    <p>Experimenta más allá del agua, deja que el tacto invada tus sentidos de principio a fin. <span>El
                        mueble Aurora, es una propuesta innovadora, sensorial y sostenible. Esta vez nuestra experiencia
                ...
                <div class="card-prestacion-lite__sub">
                  ...
                  <div class="card-prestacion-lite__text">
                    <p>Diseñamos y fabricamos nuestros propios spas con distinción europea. <span>Ante la tendencia
                        ...
                        Barcelona), de todos nuestros spas, piscinas contracorriente y cada uno de sus componentes.</span>
                    </p>
                    <a class="card-prestacion-lite__text-plus" href="#">
                      <img src="/dist/assets/icons/card-accesorios__text-plus.svg" alt="">
                    </a>
              ...
              <div class="card-prestacion-lite logo-down">
                ...
                <div class="card-prestacion-lite__sub">
                  ...
                  <div class="card-prestacion-lite__text">
                    <p>La fuerte influencia de una de las ciudades más creativas del mundo. <span>Barcelona es una de las
                        ciudades mundiales del diseño. Su carácter cosmopolita y su tradición creativa la convierten en una
                        de las cunas de grandes tendencias a nivel internacional y en uno de los polos de innovación en
                        Europa.</span></p>
                    <a class="card-prestacion-lite__text-plus" href="#">
                      <img src="/dist/assets/icons/card-accesorios__text-plus.svg" alt="">
                    </a>
