...
//card-category-blog--lite/Blog
export const card2 = `
<a href="#" class="card-category-blog-lite gb-card">
<div class="card-category-blog-lite__container">
  <div style="background-image: url('/dist/assets/img/card-beneficios1.webp');" class="card-category-blog-lite__bg">
...
//card-map/Donde Comprar
export const card3 = `
<button class="card-map">

<img class="card-map__img" src="/dist/assets/icons/location-dark.svg" alt="location icon">

<div class="card-map__description">
  <h3>Catalonia AquaGrup <span>(Spain)</span></h3>
  <h4>Av de la Porta Diagonal, 34. Cornellà de Llobregat (Salida 15 Rda. de Dalt).</h4>
  <div class="card-map__description--span">ShowRoom</div>
  <p>T. 933 770 665</p>
  <p>nfo@cataloniaaqua.com</p>
  <div class="d-flex align-items-center justify-content-between gap-5">
    <div class="fw-bold">www.cataloniaaqua.com</div>
    <div class="d-flex align-items-center">85km <img class="ml-auto" width="16px"
        src="/dist/assets/icons/Shape.svg" alt="Shape"></div>
  </div>
</div>
</button>
`

//card-menu--filters/Menu Lateral
export const card4 = `
<div class="card-menu-filters">
    <div style="background-image: url('/dist/assets/img/card-beneficios1.webp');" class="card-menu-filters__img">
    </div>
    <div class="card-menu-filters__span">2-3</div>
  </div>
`

//card-transform--lg/Home
export const card5 = `
<div style="background-image: url('/dist/assets/img/card-transform.webp');" class="card-transform">
    ...
    <div class="card-transform__card-inside">
      ...
      <a class="link-arrow-grow-white" href="#">
        <span>Descubre nuestros spas</span>
